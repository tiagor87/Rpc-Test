...
{
    public class RpcCommandHandler<TRequest, TResponse> : IRequestHandler<TRequest, TResponse>
...

    {
        ...
        public RpcCommandHandler(IBusRpcClient busClient, IOptions<BusRpcOptions<TRequest, TResponse>> options)
        {
